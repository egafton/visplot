 ...
 config["HJST"] = {
    ...
    declinationLimit: ["alt(az)", function(az, west=false, instr=null) {
        ...
        let spline = helper.bspleval(
            ...
            west ? config["HJST"]._west_knots : (instr === "GCMS" ? config["HJST"]._east_knots_GCMS : config["HJST"]._east_knots),
            west ? config["HJST"]._west_coeffs : (instr === "GCMS" ? config["HJST"]._east_coeffs_GCMS : config["HJST"]._east_coeffs));
        if (west) {
    ...
    _east_knots_GCMS: [ 0.0, 0.0, 1.8, 3.0, 4.2, 31.5, 61.2, 64.2, 178.0, 180.0, 194.4, 198.2, 212.2, 224.0, 230.5, 240.8, 245.5, 250.1, 256.6, 261.0, 277.8, 338.4, 340.6, 359.9, 360.0, 360.0 ],
    _east_coeffs_GCMS: [ 41.0, 40.9, 39.8, 39.5, 55.0, 51.7, 57.8, 9.0, 12.0, 10.3, 18.9, 11.9, 12.0, 12.2, 8.3, 11.6, 12.3, 21.3, 52.3, 43.1, 39.5, 41.4, 50.4, 50.4, 0.0, 0.0 ],
