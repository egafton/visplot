    ...
    <div id="container">
        <div id="leftblock">
            ...
            <!--<span class="middle"><label for="opt_color">Colour: 
                <input type='radio' name="opt_color" id="opt_color" value="same" checked /> Uniform 
                <input type='radio' name="opt_color" id="opt_color" value="type" /> Type
                <input type='radio' name="opt_color" id="opt_color" value="proposal" /> Proposal
                <input type='radio' name="opt_color" id="opt_color" value="individual" /> Individual
            </label></span><br/><br/>-->
                <div id="buttons">
